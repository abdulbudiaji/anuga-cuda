...
#ifndef HMPPRT_CUDA_GRID_H
#define HMPPRT_CUDA_GRID_H

#include <string>

#include <hmpprt/Common.h>
#include <hmpprt/CUDADevice.h>
...
public:
  ...
  HMPPRT_API
  CUDAGrid(CUDAModule * module, const char * function_name);
...
public:
  ...
  HMPPRT_API
  void launch(CUDAGrid * grid, CUDADevice * device);
...
//private:
  ...
  enum ParamType { PT_DATA_PTR, PT_INT, PT_FLOAT, PT_SIZED_VALUE };
