 ...
 */
  ...
  INTERFACE
    ...
    ! Async
    FUNCTION acc_async_test( arg ) result(out) bind(C,name="acc_async_test_m1_")
      USE ISO_C_BINDING
      LOGICAL(C_BOOL) :: out
      INTEGER(C_INT), INTENT(IN) :: arg
    END FUNCTION acc_async_test
    FUNCTION acc_async_test_all() result(out) bind(C,name="acc_async_test_all_m1_")
      USE ISO_C_BINDING
      LOGICAL(C_BOOL) :: out
    ...
    FUNCTION acc_on_device( devicetype ) result(out) bind(C,name="acc_on_device_m1_")
      USE ISO_C_BINDING
      LOGICAL(C_BOOL) :: out
      INTEGER(C_INT), INTENT(IN) :: devicetype
