...
name_list = ['max_speed', 
                ...
                'stage_centroid', 'elevation_centroid', 'xmom_centroid',
                'ymom_centroid', 
                'height_centroid', 'xvelocity_centroid', 
                'yvelocity_centroid', 
                'friction_centroid',
                
                'stage_vertex', 'elevation_vertex', 'xmom_vertex', 
                'ymom_vertex', 
                'height_vertex', 'xvelocity_vertex', 'yvelocity_vertex', 
                
                'stage_explicit_update', 'xmom_explicit_update', 
                'ymom_explicit_update', 
                'stage_semi_implicit_update', 'xmom_semi_implicit_update', 
                'ymom_semi_implicit_update', 

                'stage_x_gradient', 'elevation_x_gradient', 
                'xmom_x_gradient', 
                'ymom_x_gradient', 'height_x_gradient', 
                'xvelocity_x_gradient', 
                'yvelocity_x_gradient', 
                
                'stage_y_gradient', 'elevation_y_gradient', 
                'xmom_y_gradient', 
                'ymom_y_gradient', 'height_y_gradient', 
                'xvelocity_y_gradient', 
                'yvelocity_y_gradient', 

                'stage_boundary', 'elevation_boundary', 'xmom_boundary', 
                'ymom_boundary', 
                'height_boundary', 'xvelocity_boundary', 
                'yvelocity_boundary' 
            ]
...
def check_all_with_copy_back(domain, test_domain):
    """Check all the result"""
    ...
    check_result(domain, test_domain, "max_speed")
    
    
    check_result(domain.quantities['stage'], 
            test_domain.quantities['stage'], "edge_values")
    check_result(domain.quantities['elevation'], 
            test_domain.quantities['elevation'], "edge_values")
    check_result(domain.quantities['xmomentum'], 
            test_domain.quantities['xmomentum'], "edge_values")
    check_result(domain.quantities['ymomentum'], 
            test_domain.quantities['ymomentum'], "edge_values")
    check_result(domain.quantities['height'], 
            test_domain.quantities['height'], "edge_values")
    check_result(domain.quantities['xvelocity'], 
            test_domain.quantities['xvelocity'], "edge_values")
    check_result(domain.quantities['yvelocity'], 
            test_domain.quantities['yvelocity'], "edge_values")
    ...
    check_result(domain.quantities['yvelocity'], 
            test_domain.quantities['yvelocity'], "centroid_values")
    check_result(domain.quantities['friction'], 
            test_domain.quantities['friction'], "centroid_values")
