...
if __name__ == '__main__':
    ...
    if  testing_gpu_domain:
        ...
        compute_fluxes_mod = SourceModule(
                host_macro+ open( 
                    kp["compute_fluxes_dir"]+"compute_fluxes.cu").read(),
                arch = 'compute_20',
                code = 'sm_20'
        ...
        ini_time = time.time()
        compute_fluxes_central_function.prepared_call(
                ((domain2.number_of_elements+W1*W2*W3-1)/(W1*W2*W3), 1),
                (W1, W2, W3),
                domain2.number_of_elements,
                domain2.evolve_max_timestep,
                domain2.g,
                domain2.epsilon,
                domain2.H0 * domain2.H0,
                domain2.H0 * 10,
                domain2.optimise_dry_cells,
